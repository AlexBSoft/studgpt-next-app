    ...
    <>
      ...
      <div className="relative h-screen w-full lg:ps-64">
        <div className="py-10 lg:py-14">
          ...
          <span className="">
            Сохраняйте часто используемые данные в контексты, чтобы вставлять их
            в сообщение префиксом "@". Экономит ваше время, если часто
            приходится работать с одним куском текста.
          </span>
          В разработке...
